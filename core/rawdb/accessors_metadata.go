...
func ReadChainConfig(db ethdb.KeyValueReader, hash common.Hash) *params.ChainConfig {
	...
	// Modify the TTD difficulty value read from genesis at source, set it to nil
	// The congress version 1.10.13 was an intermediate version where TerminalTotalDifficulty was incomplete
	// The original genesis set it to 0, which conflicts with the current logic
