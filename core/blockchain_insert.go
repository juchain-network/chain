...
func (it *insertIterator) next() (*types.Block, error) {
	...
	log.Debug("block_fetcher insertIterator next action", "number", it.chain[it.index].Number(), "hash", it.chain[it.index].Hash(), "miner", it.chain[it.index].Coinbase(), "withdrawHash", it.chain[it.index].Header().WithdrawalsHash, "withdrawals", it.chain[it.index].WithdrawalStr())
