...
func (b *Block) WithdrawalStr() string {
...
// SetWithdrawals set withdrawals to an exists block without any checks
func (b *Block) SetWithdrawals(withdrawals []*Withdrawal) *Block {
