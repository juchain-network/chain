...
type Engine interface {
	...
	// GetChainConfig returns the chain configuration associated with the consensus engine
	// This method is needed because some places cannot access the Config, but need to perform rule validation
